  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        ...
        {/* Comment badge + inline popover — both in canvas coords so they follow pan/zoom */}
        {relation?.comment && (() => {
          const badgeY = labelY + (relation.hasForeignKey ? 18 : 0);
          return (
            <>
              <div
                ...
                style={{
                  position: 'absolute',
                  transform: `translate(-50%, -50%) translate(${labelX}px, ${badgeY}px)`,
                  cursor: 'pointer',
                  pointerEvents: 'all',
                  userSelect: 'none',
              ...
              {commentOpen && (
                <div style={{
                  position: 'absolute',
                  transform: `translate(-50%, 0%) translate(${labelX}px, ${badgeY + 12}px)`,
                  background: '#fffde7',
